...
class PurchaseOrderLine(models.Model):
    ...
    #         return price
    #
    #     # If price is the same, call the super method without modifying the price_unit
    ...
    # def write(self, vals):
    #     if "discount" in vals or "price_unit" in vals:
    #         lines_to_update_moves = self.filtered(lambda l: l.order_id.state == "purchase")
    #         for line in lines_to_update_moves:
    #             # Avoid updating kit components' stock.move
    #             moves = line.move_ids.filtered(
    #                 lambda s: s.state not in ("cancel", "done")
    #                           and s.product_id == line.product_id
